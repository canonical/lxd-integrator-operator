...
class Lxd(Object):
    ...
    def is_ready(self) -> bool:
        return all([self.state.endpoint, self.state.client_cert,
                    self.state.client_key, self.state.server_cert])
    ...
    def _new_connection(self) -> httpclient.HTTPSConnection:
        ...
        sslcontext = ssl.create_default_context(purpose=ssl.Purpose.CLIENT_AUTH, cafile=SERVER_CERT_PATH)
    ...
    def set_credentials(self, endpoint: str, client_cert: str, client_key: str, server_cert: str) -> None:
